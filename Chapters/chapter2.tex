...
In fact, the \keyword{Scanner} API is not this simple, however it was reduced to the simplest possible for the example.
...
method readClosedFile(f) {
    ...
    \end{minted}
    \caption{The \keyword{File} declaration and usage in Plaid.}
...
% TODO arranjar exemplo obsidian
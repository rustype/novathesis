...
For example, session types, a subset of behavioral types,
will often refer to endpoints and their messages, capturing aspects of communication between them.
Typestates, another subset of behavioral types, capture the state of the program,
